...
async def info_cmd(client, message):
	...
	await edit_or_reply(message,
		...
		f"<code> → </code> <b>cpu load [</b><code>{cpu_count}x{cpu_freq/1000:.1f}GHz</code><b>]</b> <code>{cpu_usage:.2f}%</code> (<code>{cpu_load:.2f}%</code> system)\n" +
		f"<code> → </code> <b>mem use [</b><code>{order_suffix(total_ram)}</code><b>]</b> <code>{ram_usage:.2f}%</code> (<code>{ram_load:.2f}%</code> system)\n" +
